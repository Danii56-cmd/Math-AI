...
class AppConstants {
  ...
  static String containerBg = "assets/images/container-background.png";
  static String cameraIcon = "assets/images/camera-icon.png";
  static String galleryIcon = "assets/images/gallery-icon.png";
  static String keyboardIcon = "assets/images/keyboard-icon.png";
  static String aiIcon = "assets/images/Ai-tutor-icon.png";
  static String quadraticIcon = "assets/images/quadratic-icon.png";
